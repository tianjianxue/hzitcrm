...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $customerInfo_dataGrid = $("#customerInfo_datagrid").datagrid({
                url: '${pageContext.request.contextPath}/userInfo/customerStateList',
                pagination: true,
                rownumbers: true,
                singleSelect: false,
                selectOnCheck: true,
    ...
    <script>
        ...
        function studentInfo(){
            ...
            if (customerInfoArr.length === 1) {
                var editDialog = $('<div/>').dialog({
                    href: '${pageContext.request.contextPath}/studentInfo/studentInfo?customerId='+customerInfo.customerId,
                    width: 300,
                    height: 280,
                    modal: true,
                    title:'学员进班',
                    buttons: [{
                        ...
                        handler: function () {
                            ...
                            $('#studentInfoForm').form('submit', {
                                url: '${pageContext.request.contextPath}/studentInfo/studentInfoData',
                ...
                $.messager.alert('警告', '所选数据大于1条，请选择一条要进班的数据!');
            } else {
                $.messager.alert('警告', '请选择要进班的数据!');
            }
...
<script type="text/javascript">
    ...
    function queryFun(){
        ...
        var url = "${pageContext.request.contextPath}/userInfo/customerStateList?"+comboxValue+"="+$("#queryText").val()+"&currentUser=1";
